...
# class Index(FormView.View):
#     template_name = 'index.html'

# def customer_url_details(request, id=None):
#     instance = get_object_or_404(CustomerUrl, pk=id)
#     instance_password = instance.password
#     date_now = idt.datetime.now()
...
#         "instance_absolute_url": instance.get_absolute_url(),
#         "instance_app_url": request.build_absolute_uri(),
#         "date_now": date_now,
#     }
#
#     return render(request, 'zad/url.html', context)
#
#
# def customer_file_details(request, id=None):
...
#         "date_now": date_now,
#     }
#     return render(request, 'zad/file.html', context)
